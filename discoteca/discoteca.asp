...
<style>
<!--
td {color:#000000; font-size:14px; font-family:Verdana, Tahoma, Helvetica }
.main {color:#000000; font-size:14px; font-family:Verdana, Tahoma, Helvetica }
-->
</style>
<bgsound src="impermeabilivoce.wav" loop="1">
...
<body bgcolor="#CCFFFF" onload="FP_preloadImgs(/*url*/'../bungalows/buttonA6.jpg', /*url*/'../bungalows/buttonA5.jpg', /*url*/'../bungalows/buttonA9.jpg', /*url*/'../bungalows/buttonA8.jpg', /*url*/'../bungalows/buttonAC.jpg', /*url*/'../bungalows/buttonAB.jpg', /*url*/'../bungalows/buttonAF.jpg', /*url*/'../bungalows/buttonAE.jpg', /*url*/'../bungalows/buttonB2.jpg', /*url*/'../bungalows/buttonB1.jpg', /*url*/'../bungalows/buttonB5.jpg', /*url*/'../bungalows/buttonB4.jpg', /*url*/'../bungalows/buttonB8.jpg', /*url*/'../bungalows/buttonB7.jpg', /*url*/'../bungalows/buttonBB.jpg', /*url*/'../bungalows/buttonBA.jpg', /*url*/'../bungalows/buttonBE.jpg', /*url*/'../bungalows/buttonBD.jpg', /*url*/'../bungalows/buttonC1.jpg', /*url*/'../bungalows/buttonC0.jpg', /*url*/'../bungalows/buttonC4.jpg', /*url*/'../bungalows/buttonC3.jpg', /*url*/'../bungalows/buttonC7.jpg', /*url*/'../bungalows/buttonC6.jpg', /*url*/'../bungalows/buttonCA.jpg', /*url*/'../bungalows/buttonC9.jpg', /*url*/'button8.jpg', /*url*/'button7.jpg', /*url*/'button5.jpg', /*url*/'button9.jpg')">
      ...
      <p align="center"><b><font face="Verdana" size="6" color="#003399"><%= Request.ServerVariables("HTTP_HOST") %></font></b>
		...
		<div style="position: absolute; width: 119px; height: 806px; z-index: 4; left: 9px; top: 42px; border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #99CCFF" id="livello6">
			<p align="center"><b>DISCOTECA</b></p>
			<table border="1" width="100%" id="table2">
				<tr>
					<td>
					<img border="0" src="../home/logo%20valle%20del%20noce.jpg" width="94" height="113" align="right"><p>&nbsp;</td>
				</tr>
				<tr>
					<td>
			<p align="center" style="margin-top: 15px; margin-bottom: 15px">
			<a href="../default.asp">
			<img border="0" id="img46" src="button4.jpg" height="20" width="100" alt="HOME" onmouseover="FP_swapImg(1,0,/*id*/'img46',/*url*/'button5.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img46',/*url*/'button4.jpg')" onmousedown="FP_swapImg(1,0,/*id*/'img46',/*url*/'button9.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img46',/*url*/'button5.jpg')" fp-style="fp-btn: Corporate 1; fp-bgcolor: #800000" fp-title="HOME"></a></p>
			<p align="center" style="margin-top: 15px; margin-bottom: 15px">
			...
			<img border="0" id="img45" src="button6.jpg" height="20" width="100" alt="EVENTI 2012" onmouseover="FP_swapImg(1,0,/*id*/'img45',/*url*/'button7.jpg')" onmouseout="FP_swapImg(0,0,/*id*/'img45',/*url*/'button6.jpg')" onmousedown="FP_swapImg(1,0,/*id*/'img45',/*url*/'button8.jpg')" onmouseup="FP_swapImg(0,0,/*id*/'img45',/*url*/'button7.jpg')" fp-style="fp-btn: Corporate 1; fp-bgcolor: #800000; fp-orig: 0" fp-title="EVENTI 2012"></a><p>&nbsp;</td>
				</tr>
				<tr>
      ...
      <div style="position: absolute; width: 1006px; height: 49px; z-index: 12; left: 135px; top: 43px" id="livello16">
		<p align="justify">Personale qualificato, dopo la cena,&nbsp; provvederà 
		ad&nbsp; allietare gli ospiti con tantissime iniziative di spettacolo 
		che coinvolgeranno tutti indistintamente, sia&nbsp; con balli di gruppo 
		che con sfilate e concorsi, canzoni al&nbsp; Karaoke e giochi di 
		società.</p></div>
      ...
      <p>&nbsp;</p>
		<p align="center">&nbsp;</p>
		<p align="center">&nbsp;</p>
		<div style="position: absolute; width: 182px; height: 99px; z-index: 1; left: 530px; top: 1123px" id="livello9">
			<p align="center" style="margin-top: 0; margin-bottom: 0">
			<img border="0" src="../bungalows/BOTTONI/email.gif" width="38" height="38"><p align="center" style="margin-top: 0; margin-bottom: 0">
			<i><a href="mailto:info@villaggiovalledelnoce.it">
			info@villaggiovalledelnoce.it</a>&nbsp; Per informazioni telefonare 0815165171 / 0815138849</i><p align="center" style="margin-top: 0; margin-bottom: 0">
			3301313536</div>
		<p>&nbsp;</p>
		<div style="position: absolute; width: 32px; height: 6px; z-index: 16; left: 454px; top: 253px" id="livello22">
										<div style="position: absolute; width: 100px; height: 100px; z-index: 1; left: -320px; top: -156px" id="livello24">
											<table border="1" width="100%" id="table1">
												<tr>
													<td>
													<img border="0" src="discoteca2013-5.jpg" width="495" height="334"></td>
													<td>
													<img border="0" src="discoteca2010.JPG" width="494" height="336"></td>
												</tr>
												<tr>
													<td>
													<img border="0" src="discoteca2013-6.JPG" width="496" height="331"></td>
													<td>
													<img border="0" src="discoteca2013-4.JPG" width="496" height="331"></td>
												</tr>
												<tr>
													<td>
													<img border="0" src="discoteca2013-2.JPG" width="496" height="331"></td>
													<td>
													<img border="0" src="discoteca2013-3.JPG" width="496" height="331"></td>
												</tr>
											</table>
										</div>
&nbsp;</div>
